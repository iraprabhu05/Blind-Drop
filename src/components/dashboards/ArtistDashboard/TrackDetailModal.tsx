          ...
          <div>
            ...
            <div className="space-y-3 mt-3">
              <div className="flex items-center gap-3 text-lg">
                ...
                <span>
                  <span className="font-bold">{track.plays}</span> plays
                </span>
              </div>
              <div className="flex items-center gap-3 text-lg">
                <Heart className="text-pink-400" size={20} />
                <span>
                  <span className="font-bold">{track.likes}</span> likes
                </span>
              </div>
              <div className="flex items-center gap-3 text-lg">
                <Calendar className="text-blue-400" size={20} />
                <span>
                  Uploaded on <span className="font-bold">{track.date}</span>
                </span>
              </div>
            </div>
            <div className="mt-6">
              ...
              <div className="flex gap-3 mt-3">
                <Button
                  variant="outline"
                  className="border-violet-500 text-violet-400 hover:bg-violet-500/10 hover:text-violet-300"
                >
                  Edit Details
                </Button>
