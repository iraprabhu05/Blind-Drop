...
const Reveal = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden relative">
      ...
      <div className={`fixed inset-0 transition-opacity duration-1000 ${revealed ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="glass-panel p-8 rounded-3xl shadow-neon-combined mb-8">
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 mb-6">
                    ...
                    <div className="flex gap-0.5">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <span key={star} className={star <= 4 ? "text-neon-violet" : "text-muted-foreground/30"}>
                          ★
                        </span>
                      ))}
                    </div>
